  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="https://nuxtjs.org" target="_blank">
        <svg fill="none" height="45" viewBox="0 0 159 30" width="218" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a class="text-green-500 hover:underline" href="https://nuxtjs.org"
                                                 target="_blank">Nuxt documentation</a>, whether
          you are new or have previous experience with the framework.<br>
        </p>
